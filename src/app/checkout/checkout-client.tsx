  ...
  return (
    <div className="mx-auto grid max-w-5xl gap-8 px-4 py-10 md:grid-cols-[2fr_1fr]">
      <Card className="border-[#f0f0f0]">
        <CardHeader>
          <CardTitle>معلومات العميل — الدفع عند الاستلام</CardTitle>
        </CardHeader>
        <CardContent>
          <form className="space-y-4" onSubmit={submit}>
            ...
            <div className="space-y-2">
              ...
              <Input className="border-[#f0f0f0]" value={city} onChange={(e) => setCity(e.target.value)} required />
            </div>
            <div className="space-y-2">
            ...
            <Button type="submit" className="w-full bg-black text-white hover:bg-[#343434]" disabled={loading}>
              {loading ? "جاري الإرسال..." : "اطلب الآن — تأكيد الطلب"}
            </Button>
          </form>
        </CardContent>
      </Card>
